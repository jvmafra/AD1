...
ggplot(agrupa_nome, aes(x = reorder(Nome, total_gasto),  
  ...
  geom_point(data = agrupa_atividade, aes(x = Nome, y = Divulgacao, size = Divulgacao), colour = "white", show.legend = TRUE, shape = 15) +
  
  geom_point(data = gastos_pb, aes(x = Nome, y = Valor), colour = "white", show.legend = FALSE)
