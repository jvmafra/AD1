...
As observações/convênios foram filtrados para considerar apenas os estados nordestinos. Além disso, a fim de restringir mais a quantidade de dados, foram filtrados aquele convênios cuja função imputada está na área de urbanismo. Saúde e Urbanismo são as duas áreas onde mais repasses de emendas parlamentares são feitas. Valores maiores são repassados para Saúde, porém mais cidades são contempladas com emendas para segunda opção, o que motivou minha escolha para ela.
...
ggplot(df, aes(x = valor_2014, y = valor_2015, colour = grupo)) + 
  ...
  ylab("Total destinado em 2015 (Urbanismo)")
...
Conforme esperado, muitas das capitais figuram no grupo azul, a exemplo de Fortaleza, Maceió, Teresina, Salvador, Recife e Aracaju. Da Paraíba, Campina Grande e Guarabira estão presentes. João Pessa não recebeu muitos repasses na área de saúde, mas nenhuma de Urbanismo nesses dois anos. Natal e São Luís não aparecem nesse agrupamento pois não possuem repasses recebidos registrados em 2014, apenas em 2015.
